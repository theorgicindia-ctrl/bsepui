...
export default function LoginScreen({ navigation }) {
    ...
    const [request, response, promptAsync] = Google.useAuthRequest({
        expoClientId:
            "685685363348-9v0fsc2pcj3m3mfsd4aassmmhj87abdp.apps.googleusercontent.com",
        iosClientId:
            "685685363348-9v0fsc2pcj3m3mfsd4aassmmhj87abdp.apps.googleusercontent.com",
    ...
    const handleCustomLogin = async () => {
        ...
        try {
            ...
            setUser(res.data);
            // navigation handled by root based on user state
        } catch (err) {
            const msg =
...
const styles = StyleSheet.create({
    ...
    // Legacy input style kept for reference (not used now because we use S.input)
    input: {
        width: "100%",
        backgroundColor: "#fff",
        padding: 12,
    ...
    orText: { marginHorizontal: 10, color: C.subtext, fontSize: 12 },
});
